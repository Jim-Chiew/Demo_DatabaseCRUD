package sg.edu.rp.c346.id20004713.demodatabasecrud;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("ALTER TABLE " + TABLE_NOTE + " ADD COLUMN  module_name TEXT ");  //Used to update a table without dropping all the items in database.
    }
